...
<div id="main-content">
   ...
   <div class="page-title">
      <div>
         <h1><i class="fa fa-file-o"></i> A-Z Dashboard</h1>
   ...
   <div class="row">
                  ...
                  <div class="col-md-6 tile-active">
                     <a class="tile tile-pink" data-stop="3000" href="http://codecanyon.net/item/flaty-wp-premium-wordpress-flat-admin-template/5329999">
                        <div class="img img-center">
                           <img src="{{ asset('public/img/demo/wp-logo.png') }}" />
                        </div>
      ...
      <div class="col-md-5">
         ...
         <div class="row">
            <div class="col-md-12 tile-active">
               <div class="tile tile-img" data-stop="3500" style="background-image: {{ asset('public/img/demo/gallery/5.jpg') }};">
         ...
         <div class="box box-magenta">
            ...
            <div class="box-content">
               <ul class="messages slimScroll" style="height: 300px">
                  <li>
                     <img src="{{ asset('public/img/demo/avatar/avatar2.jpg') }}" alt="">
                     <div>
                        <div>
                           <h5>David</h5>
                  ...
                  <li>
                     <img src="{{ asset('public/img/demo/avatar/avatar3.jpg') }}" alt="">
                     <div>
                        <div>
                           <h5>Sarah</h5>
                  ...
                  <li>
                     <img src="{{ asset('public/img/demo/avatar/avatar4.jpg') }}" alt="">
                     <div>
                        <div>
                           <h5>Emma</h5>
                  ...
                  <li>
                     <img src="{{ asset('public/img/demo/avatar/avatar5.jpg') }}" alt="">
                     <div>
                        <div>
                           <h5>John</h5>
                  ...
                  <li>
                     <img src="{{ asset('public/img/demo/avatar/avatar1.jpg') }}" alt="">
                     <div>
                        <div>
   ...
   <!-- END Main Content -->
   <footer>
      <p>@php echo date('Y'); @endphp © <a href="">A-Z Technical Solutions </a> Powered By <a href="codaxoinfotech.com">Codaxo Information Technology </a></p>
   </footer>
